...
issuer and issuance protocol, and may be additionally bound to an origin name or
origin context.
...
to reusing tokens that were fetched for other contexts. When present, this valid
is a fresh 32-byte context generated by the origin. This value can be a unique
...
32 bytes. Challenges with redemption_context values of invalid lengths MUST
be ignored.
